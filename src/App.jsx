...
function runLBO(ntmRev,ntmRevX,ebitdaPct,growthPct,endMarginPct,exitMultOverride,entryTEVOverride,ltmEBITDAOv,otherConv,companyName,g2027Rate,baseCAGR){
  ...
  const exitEBITDAMult=exitMultOverride!=null?exitMultOverride:Math.min(entryEBITDAMult,LBO_MAX_EXIT);
...
const RAW=[
  // ── PURE-PLAY VSaaS ──
  {name:"Bentley Systems",vertical:"Construction & Design SW",bucket:"Pure-Play VSaaS",hq:"US",sor:true,seat:true,pricing:"Seat-Based",peOwned:false,tev:11842.9,ntmRev:1756.8,ntmEBITDA:636.6,growth:13,gm:82,ebitda:36,cagr:11.75,ntmRevX:6.74,peFit:"Medium",aiRisk:"Low",avoid:false,ltmEbitda:552.4,pct52w:0.597,
  ...
  {name:"CCC Intelligent Solutions",vertical:"Financial Services",bucket:"Pure-Play VSaaS",hq:"US",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:4747.6,ntmRev:1186.1,ntmEBITDA:497.3,growth:9,gm:78,ebitda:42,cagr:8.89,ntmRevX:4.0,peFit:"High",aiRisk:"Low",avoid:false,ltmEbitda:450.6,pct52w:0.562,
   ...
   thesis:["The network is the moat: CCC connects insurers, body shops, OEMs, and parts suppliers in a single data exchange — switching any one node requires coordinating all counterparties, which never happens","9% topline growth masks the real story: ARPU expansion via Casualty (injury claims), Emerging Solutions (subrogation, total loss), and AI upsell modules drive revenue per claim higher each year","Kill-the-deal risk: Tractable (AI photo-based damage estimation) has signed Tokio Marine, Covea, and US insurers — if Tractable cracks the network effect by going insurer-first, CCC's body shop lock-in weakens","Exit buyer universe is narrow: Verisk and Guidewire are logical strategics but both have antitrust overlap in P&C claims — strategic exit constraints favor a longer hold or adjacency-led expansion before exit"],
  ...
  // ── HYBRID VSaaS ──
  {name:"Cellebrite",vertical:"GovTech",bucket:"Hybrid VSaaS",hq:"IL",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:2987.7,ntmRev:598.0,ntmEBITDA:162.1,growth:19,gm:85,ebitda:27,cagr:18.1,ntmRevX:5.00,peFit:"High",aiRisk:"Low",avoid:false,ltmEbitda:135.2,pct52w:0.654,
   ...
   sd:{sharePrice:13.18,sharesOut:259.85,marketCap:3424.8,netDebt:-437.1},
  ...
  {name:"nCino",vertical:"Financial Services",bucket:"Pure-Play VSaaS",hq:"US",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:2375.6,ntmRev:655.3,ntmEBITDA:181.3,growth:8,gm:68,ebitda:27,cagr:8.42,ntmRevX:3.63,peFit:"Medium",aiRisk:"Medium",avoid:false,ltmEbitda:143.8,pct52w:0.565,
...
{hidden:true,name:"Toast",vertical:"Restaurant Tech",bucket:"Hybrid VSaaS",hq:"US",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:14326,ntmRev:7735,growth:20,gm:28,ebitda:11,cagr:19.1,ntmRevX:1.85,peFit:"Medium",aiRisk:"Medium",avoid:false,ltmEbitda:673,pct52w:0.54,
  ...
  {name:"HubSpot",vertical:"Marketing & CRM",bucket:"Pure-Play VSaaS",hq:"US",sor:false,seat:true,pricing:"Seat-Based",peOwned:false,tev:10253.7,ntmRev:3881.8,ntmEBITDA:953.5,growth:18,gm:85,ebitda:24,cagr:17.0,ntmRevX:2.64,peFit:"High",aiRisk:"Medium",avoid:false,ltmEbitda:771.3,pct52w:0.331,
  ...
  {name:"Dynatrace",vertical:"Observability & APM",bucket:"Pure-Play VSaaS",hq:"US",sor:false,seat:false,pricing:"Usage-Based",peOwned:false,tev:9852.5,ntmRev:2324.9,ntmEBITDA:717.5,growth:15,gm:84,ebitda:31,cagr:14.94,ntmRevX:4.24,peFit:"High",aiRisk:"Low",avoid:false,ltmEbitda:612.8,pct52w:0.629,
  ...
  {name:"DocuSign",vertical:"eSignature & CLM",bucket:"Pure-Play VSaaS",hq:"US",sor:true,seat:true,pricing:"Seat-Based",peOwned:false,tev:9114,ntmRev:3558.7,ntmEBITDA:1204.9,growth:8,gm:82,ebitda:34,cagr:8.2,ntmRevX:2.56,peFit:"High",aiRisk:"Medium",avoid:false,ltmEbitda:1095,pct52w:0.487,
  ...
  {name:"Procore",vertical:"Construction Tech",bucket:"Pure-Play VSaaS",hq:"US",sor:true,seat:true,pricing:"Seat-Based",peOwned:false,tev:8030.7,ntmRev:1553.6,ntmEBITDA:391.4,growth:13,gm:84,ebitda:25,cagr:12.86,ntmRevX:5.17,peFit:"High",aiRisk:"Low",avoid:false,ltmEbitda:319.0,pct52w:0.697,
  ...
  {name:"Paycom",vertical:"HR & Payroll",bucket:"Pure-Play VSaaS",hq:"US",sor:true,seat:false,pricing:"Usage-Based",peOwned:false,tev:6704.0,ntmRev:2237.4,ntmEBITDA:985.4,growth:7,gm:84,ebitda:44,cagr:6.72,ntmRevX:3.0,peFit:"High",aiRisk:"Low",avoid:false,ltmEbitda:907.8,pct52w:0.478,
  ...
  {hidden:true,name:"JFrog",vertical:"DevOps & MLOps",bucket:"Pure-Play VSaaS",hq:"US",sor:false,seat:false,pricing:"Usage-Based",peOwned:false,tev:5150.3,ntmRev:658.1,ntmEBITDA:127.6,growth:17,gm:83,ebitda:19,cagr:17.0,ntmRevX:7.83,peFit:"Medium",aiRisk:"Medium",avoid:false,ltmEbitda:102,pct52w:0.640,
...
const TOP5_DATA={
  ...
  "CCC Intelligent Solutions":{
    ...
    thesis:[
      "4.0x NTM Revenue with 42% EBITDA is the deepest value among high-quality, low-AI-risk SoRs — PE equity creation from organic growth compounding at current entry multiples is highly compelling",
...
const COMPANY_FINANCIALS={
  ...
  "Cellebrite":{rev24:401.2,rev25:475.7,ebitda25:127.6,sbc25:44.9,da25:7.3,other25:33.6,rev26:569.0,rev27:661.4,ebitda26:152.0,ebitda27:184.6,sbc26:53.7,sbc27:62.4,da26:7.3,da27:9.6,other26:35.1,other27:42.4},
...
export default function App(){
  ...
  const companies=RAW.map(co=>{
    ...
    // Terminal margin = 2027 consensus + 10pp capped at 40%; ≥40% stays flat; fallback to NTM ebitda for companies without fin data
    ...
    const ntmEBITDAX=Math.round((co.tev/(co.ntmEBITDA??co.ntmRev*co.ebitda/100))*10)/10;
